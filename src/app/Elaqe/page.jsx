      ...
      <div className="container mx-auto p-4 md:p-8 lg:p-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="text-center">
            ...
            <p className="mt-2 text-gray-500 dark:text-gray-400"><br />0123100101<br /></p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="mt-2 text-gray-500 dark:text-gray-400">-<br />email əlaqə<br />sales@gotelecom.az</p>
          </div>
        </div>
      </div>
    </div>
